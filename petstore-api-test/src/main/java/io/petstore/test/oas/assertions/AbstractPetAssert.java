...
import io.petstore.test.oas.client.model.Tag;
...
public abstract class AbstractPetAssert<S extends AbstractPetAssert<S, A>, A extends Pet> extends AbstractObjectAssert<S, A> {
   ...
   */
  public S hasCategory(io.petstore.test.oas.client.model.Category category) {
    ...
    // null safe check
    io.petstore.test.oas.client.model.Category actualCategory = actual.getCategory();
   ...
   */
  public S hasStatus(io.petstore.test.oas.client.model.Pet.StatusEnum status) {
    // check that actual Pet we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    io.petstore.test.oas.client.model.Pet.StatusEnum actualStatus = actual.getStatus();
